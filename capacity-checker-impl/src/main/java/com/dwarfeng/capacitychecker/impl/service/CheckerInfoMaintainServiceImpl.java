...
public class CheckerInfoMaintainServiceImpl implements CheckerInfoMaintainService {
    ...
    private final DaoOnlyBatchCrudService<LongIdKey, CheckerInfo> crudService;
    private final DaoOnlyEntireLookupService<CheckerInfo> entireLookupService;

    public CheckerInfoMaintainServiceImpl(
            DaoOnlyBatchCrudService<LongIdKey, CheckerInfo> crudService,
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public CheckerInfo get(LongIdKey key) throws ServiceException {
    ...
    public LongIdKey insert(CheckerInfo element) throws ServiceException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public CheckerInfo getIfExists(LongIdKey key) throws ServiceException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public LongIdKey insertIfNotExists(CheckerInfo element) throws ServiceException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public LongIdKey insertOrUpdate(CheckerInfo element) throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<CheckerInfo> batchGet(@SkipRecord List<LongIdKey> keys) throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public List<LongIdKey> batchInsert(@SkipRecord List<CheckerInfo> elements) throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<CheckerInfo> batchGetIfExists(@SkipRecord List<LongIdKey> keys) throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public List<LongIdKey> batchInsertIfExists(@SkipRecord List<CheckerInfo> elements) throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public List<LongIdKey> batchInsertOrUpdate(@SkipRecord List<CheckerInfo> elements) throws ServiceException {
