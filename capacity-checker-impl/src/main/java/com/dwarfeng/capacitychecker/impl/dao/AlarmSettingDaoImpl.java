...
import com.dwarfeng.capacitychecker.impl.bean.entity.HibernateAlarmSetting;
...
public class AlarmSettingDaoImpl implements AlarmSettingDao {
    ...
    private final HibernateBatchBaseDao<LongIdKey, HibernateLongIdKey, AlarmSetting, HibernateAlarmSetting> batchBaseDao;
