...
import com.dwarfeng.capacitychecker.impl.handler.DriverSupporter;
...
public class DriverSupportMaintainServiceImpl implements DriverSupportMaintainService {
    ...
    private final DaoOnlyCrudService<StringIdKey, DriverSupport> crudService;
    ...
    public DriverSupportMaintainServiceImpl(
            DaoOnlyCrudService<StringIdKey, DriverSupport> crudService,
            DaoOnlyEntireLookupService<DriverSupport> entireLookupService,
            DaoOnlyPresetLookupService<DriverSupport> presetLookupService,
            @Autowired(required = false) List<DriverSupporter> driverSupporters,
            ServiceExceptionMapper sem
    ) {
        this.crudService = crudService;
        this.entireLookupService = entireLookupService;
        this.presetLookupService = presetLookupService;
        this.driverSupporters = Objects.isNull(driverSupporters) ? Collections.emptyList() : driverSupporters;
        this.sem = sem;
    }
